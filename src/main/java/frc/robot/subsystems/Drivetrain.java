...
public class Drivetrain extends SubsystemBase {
  ...
  private WPI_TalonFX mL1;
  private WPI_TalonFX mL2;
  private WPI_TalonFX mR1;
  private WPI_TalonFX mR2;
  ...
  public Drivetrain() {
    ...
    mL1 = new WPI_TalonFX(Constants.Motor_Left_1_ID);
    mL2 = new WPI_TalonFX(Constants.Motor_Left_2_ID);
    mR1 = new WPI_TalonFX(Constants.Motor_Right_1_ID);
    mR2 = new WPI_TalonFX(Constants.Motor_Right_2_ID);
